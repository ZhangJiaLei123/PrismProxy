...
export function AIChatStart(arg1) {
  return window['go']['app']['App']['AIChatStart'](arg1);
}

export function AIChatStop(arg1) {
...
export function TestAIConnection(arg1) {
  return window['go']['app']['App']['TestAIConnection'](arg1);
}
